 ...
 *    Browser polyfills. These are applied before loading ZoneJS and are sorted
 *    by browsers.
 *    Application imports. Files imported after ZoneJS that should be loaded
...
/**
 * Angular Polyfills
 * Functionality required by Angular itself.
 */
